...
class ShowTexture(DrawModelFromMesh):
    ...
    def __init__(self, scene, texture=None):
        ...
        shader = ShowTextureShader()  # Use the ShowTextureShader for this mesh
        shader.compile(attributes={'position': 0, 'vertexTexCoord': 1})  # Assuming attribute locations
        ...
        show_texture_obj = ShowTexture(scene, texture)